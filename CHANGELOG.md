...
- *(changelog)* Update CHANGELOG.md for v0.3.0-beta.2 [skip ci] - ([8677a6a](https://github.com/Hephaestus-Studio/aether-api/commit/8677a6adb082313d78d60c6cadc1927c98f33381))
- Update README with English documentation and clean heading styles - ([45d33c3](https://github.com/Hephaestus-Studio/aether-api/commit/45d33c3890ea539c1ecc31b8f42bcc494e844fb3))

### Maintenance

- *(changelog)* Update cliff.toml configuration and changelog format - ([2272e21](https://github.com/Hephaestus-Studio/aether-api/commit/2272e21e36f626741339e8762f092fd6b308b49c))
...
- *(changelog)* Update CHANGELOG.md for v0.2.0 [skip ci] - ([c1169e0](https://github.com/Hephaestus-Studio/aether-api/commit/c1169e00cf12538c569aae242a617b845d796f55))

### Features

- *(website)* Implement stable/beta download channels and integrated documentation system - ([0b5e6a7](https://github.com/Hephaestus-Studio/aether-api/commit/0b5e6a750caf580e4e7acf5bbaa277b8a9d41ba6))

## [0.2.0] - 2026-08-24

### Bug Fixes

- *(response)* Add bottom padding to response body editor - ([3583d81](https://github.com/Hephaestus-Studio/aether-api/commit/3583d81e3bf70a9dd112fdb135a90389c54ff382))

### Documentation

- *(changelog)* Update CHANGELOG.md for v0.2.0-beta.4 [skip ci] - ([d0440a9](https://github.com/Hephaestus-Studio/aether-api/commit/d0440a997cae01667d358c2bbe732cd37c377971))

### Features

- *(snippet)* Support inherited headers and auth, and fix duplicate global env in switcher - ([83cf44f](https://github.com/Hephaestus-Studio/aether-api/commit/83cf44fc6ca0da83caafe2bb8bd1ae23826b6f07))
- *(explorer)* Implement inline rename on F2 and synchronize tab/editor names - ([bb9fa90](https://github.com/Hephaestus-Studio/aether-api/commit/bb9fa90c6d866c110d3be2072a46b00888c60d2c))

## [0.2.0-beta.4] - 2026-08-17

### Documentation

- *(changelog)* Update CHANGELOG.md for v0.2.0-beta.3 [skip ci] - ([d884e15](https://github.com/Hephaestus-Studio/aether-api/commit/d884e15186c1b39718795ae0ef020ca8b87c4f17))

### Release

- V0.2.0-beta.4 - ([e55b7ce](https://github.com/Hephaestus-Studio/aether-api/commit/e55b7ce5e83398b9cea2c68ead1fc6f091e8fa1c))
...
- *(website)* Update exact release artifact filenames in download links and install snippets - ([54863e4](https://github.com/Hephaestus-Studio/aether-api/commit/54863e486fc305bc3579c9e1986578367e75fd2f))

### Documentation

- *(changelog)* Update CHANGELOG.md for v0.2.0-beta [skip ci] - ([b858032](https://github.com/Hephaestus-Studio/aether-api/commit/b858032b6e0add21d1cc2c6b10f79c4af4cb3d10))

### Features

- *(website)* Create landing page and GitHub Pages deployment workflow - ([453c1c4](https://github.com/Hephaestus-Studio/aether-api/commit/453c1c46a144c298b100b10c6e2f88af2f3cdb2e))

### Maintenance

- Add enablement true for configure-pages step - ([55a4a8d](https://github.com/Hephaestus-Studio/aether-api/commit/55a4a8dec12f7aeb586171db367602b919980915))

### Release

- V0.2.0-beta.2 - ([e8a211f](https://github.com/Hephaestus-Studio/aether-api/commit/e8a211f8421491cceb548800d639eb3ff8664358))
...
- *(terminal)* Buffer startup prompt output, handle exit process, and polish tab styling - ([51f9cde](https://github.com/Hephaestus-Studio/aether-api/commit/51f9cde07a44302f661f34d3b1757514921a5182))
- *(response)* Fix collision detection and tab collapse in ResponseViewer - ([7a77b1c](https://github.com/Hephaestus-Studio/aether-api/commit/7a77b1c6c7bb4112d454651857597b3066e4f37a))
- *(editor)* Make Monaco editor in BodyEditor fit full height - ([a99df38](https://github.com/Hephaestus-Studio/aether-api/commit/a99df383e3cbb566bb31403a7b46aaa54530cff1))
- *(ui)* Fix URL variable caret offset and redesign explorer tree layout - ([c8a2af9](https://github.com/Hephaestus-Studio/aether-api/commit/c8a2af962d1f29b5bfc0c0df87d3838ba87bc08f))
- *(response)* Support pretty copy and fix raw mode content display in Monaco editor - ([8cfa483](https://github.com/Hephaestus-Studio/aether-api/commit/8cfa483e7c13b51394e9b25023152b4b80b844e2))
...
- *(ui)* Use generic placeholder for workspace location inputs - ([bec4120](https://github.com/Hephaestus-Studio/aether-api/commit/bec4120b01efd4145c01f2cb0f8ef2785170111e))
...
- *(changelog)* Update CHANGELOG.md for v0.2.0-beta [skip ci] - ([8276ef0](https://github.com/Hephaestus-Studio/aether-api/commit/8276ef05ffc6e6b5a69aa7d5749d7d18c721c9cd))
- *(changelog)* Update CHANGELOG.md for v0.2.0-beta [skip ci] - ([bb473b6](https://github.com/Hephaestus-Studio/aether-api/commit/bb473b62ae15cde184528e87a09eb7751f3af3b9))
...
- *(engine)* Add core request engine modules including HTTP client, variable resolver, yaml parser, fractional indexer, and fs scanner - ([22505ef](https://github.com/Hephaestus-Studio/aether-api/commit/22505ef2a0c151324a357a107e90af06ffd7817c))
- *(backend)* Implement workspace, collection, request, environment commands and fs watcher with standard rustdoc comments - ([6342744](https://github.com/Hephaestus-Studio/aether-api/commit/6342744019798b4f1183317876e5be42c1aefb8f))
...
- *(backend)* Add tracing logs and enable terminal stdout output - ([fd43b02](https://github.com/Hephaestus-Studio/aether-api/commit/fd43b02d594bd153da56d672b3bd9b5f0cd351d5))
...
- *(editor)* Redesign HTTP method selector dropdown with custom method support - ([08b0308](https://github.com/Hephaestus-Studio/aether-api/commit/08b03081511509cd44afb02e1854d819a6164bde))
...
- *(env)* Improve environment management, layout fitting and placeholder resolution - ([137cbeb](https://github.com/Hephaestus-Studio/aether-api/commit/137cbeb16bd89630146f1fadd24481fa0dc293f5))
- *(terminal)* Implement native multi-tab terminal with portable-pty and xterm.js - ([a653016](https://github.com/Hephaestus-Studio/aether-api/commit/a6530164ad42dcdcc7c6b3ef89f8b54e0bef0b9d))
- *(status)* Add dynamic status code colors and fix tab collision detection - ([598d403](https://github.com/Hephaestus-Studio/aether-api/commit/598d403db5bbc841343d78df64fa726b9c34aa7c))
- *(ui)* Refine sidebar, method selector, protocol menu and add drag-drop to params/headers - ([124fba1](https://github.com/Hephaestus-Studio/aether-api/commit/124fba179a1c7b8f2c0077c631e3cdbf2a4d4140))
- *(ui)* Add outer window border for frameless app windows - ([4e6713e](https://github.com/Hephaestus-Studio/aether-api/commit/4e6713edaad959f8144c267b9f924806eb1740e8))
- *(response)* Add wrap and unwrap lines toggle to response body editor - ([51f9173](https://github.com/Hephaestus-Studio/aether-api/commit/51f9173320621f86d1dcb71b245c658d0ca14fdd))
- *(ui/engine)* Refine workspace layout, environment panel, and request execution - ([35a0b8f](https://github.com/Hephaestus-Studio/aether-api/commit/35a0b8f5ac88e93b01fe74c3bf13daf27bd7dc90))
...
- *(security)* Implement in-memory master key with AES-256-GCM encryption and UX optimizations - ([b259658](https://github.com/Hephaestus-Studio/aether-api/commit/b259658bd1e7e2416e54ee0baa73a143763d670e))
...
- *(ui)* Configure minimum 1s display duration for splashscreen - ([c855507](https://github.com/Hephaestus-Studio/aether-api/commit/c855507c721cdeb8a84e7fec310ec2309ff8cb71))
- *(ui)* Redesign about dialog, relocate env selector to titlebar, and add tab search (Ctrl+Shift+A) - ([b1ccaf3](https://github.com/Hephaestus-Studio/aether-api/commit/b1ccaf3bb7ee4085bfeb1dff39ded66223f8396f))
