...
- _(changelog)_ Update CHANGELOG.md for v0.3.0-beta.2 [skip ci] - ([8677a6a](https://github.com/Hephaestus-Studio/aether-api/commit/8677a6adb082313d78d60c6cadc1927c98f33381))
...
- _(changelog)_ Update cliff.toml configuration and changelog format - ([2272e21](https://github.com/Hephaestus-Studio/aether-api/commit/2272e21e36f626741339e8762f092fd6b308b49c))

## [0.3.0-beta.2] - 2026-08-26

### Documentation

- _(changelog)_ Update CHANGELOG.md for v0.3.0-beta.1 [skip ci] - ([4bc1966](https://github.com/Hephaestus-Studio/aether-api/commit/4bc1966eaa4c7767cd6967448b37f4aacfabca0c))

## [0.3.0-beta.1] - 2026-08-25

### Documentation

- _(changelog)_ Update CHANGELOG.md for v0.2.0 [skip ci] - ([c1169e0](https://github.com/Hephaestus-Studio/aether-api/commit/c1169e00cf12538c569aae242a617b845d796f55))

### Features

- _(website)_ Implement stable/beta download channels and integrated documentation system - ([0b5e6a7](https://github.com/Hephaestus-Studio/aether-api/commit/0b5e6a750caf580e4e7acf5bbaa277b8a9d41ba6))

## [0.2.0] - 2026-08-24

### Bug Fixes

- _(response)_ Add bottom padding to response body editor - ([3583d81](https://github.com/Hephaestus-Studio/aether-api/commit/3583d81e3bf70a9dd112fdb135a90389c54ff382))

### Documentation

- _(changelog)_ Update CHANGELOG.md for v0.2.0-beta.4 [skip ci] - ([d0440a9](https://github.com/Hephaestus-Studio/aether-api/commit/d0440a997cae01667d358c2bbe732cd37c377971))

### Features

- _(snippet)_ Support inherited headers and auth, and fix duplicate global env in switcher - ([83cf44f](https://github.com/Hephaestus-Studio/aether-api/commit/83cf44fc6ca0da83caafe2bb8bd1ae23826b6f07))
- _(explorer)_ Implement inline rename on F2 and synchronize tab/editor names - ([bb9fa90](https://github.com/Hephaestus-Studio/aether-api/commit/bb9fa90c6d866c110d3be2072a46b00888c60d2c))

## [0.2.0-beta.4] - 2026-08-17

### Documentation

- _(changelog)_ Update CHANGELOG.md for v0.2.0-beta.3 [skip ci] - ([d884e15](https://github.com/Hephaestus-Studio/aether-api/commit/d884e15186c1b39718795ae0ef020ca8b87c4f17))
...
- _(changelog)_ Update CHANGELOG.md for v0.2.0-beta.2 [skip ci] - ([267dca9](https://github.com/Hephaestus-Studio/aether-api/commit/267dca95410dceb17c6428fe9a02f3487253e22f))

### Features

- _(website)_ Add bilingual EN/VI support, mobile responsive navigation, and Inter typography - ([e714b5b](https://github.com/Hephaestus-Studio/aether-api/commit/e714b5b827c1222d4aeae0dd7ce51ae6fa007d5d))
- _(website)_ Add live GitHub stars count and improve background scroll locking & fixed header - ([91c1e1a](https://github.com/Hephaestus-Studio/aether-api/commit/91c1e1ab2084affd8b71f155e37ff9eb83b1d3bf))
- _(website)_ Default landing page language mode to English - ([5453e7a](https://github.com/Hephaestus-Studio/aether-api/commit/5453e7a8b93fdd018106df005274f7f637d006c9))
- _(ui)_ Add rounded window corners in non-maximized state and sync splash screen - ([0116d4e](https://github.com/Hephaestus-Studio/aether-api/commit/0116d4eb4e4999a0f7a169b757fb01c89132a2ec))
- _(ui)_ Add visual icons to titlebar menubar dropdown items - ([4f89705](https://github.com/Hephaestus-Studio/aether-api/commit/4f89705d9f3cff17a1d6172c7d355ed262179d71))
...
- _(website)_ Update exact release artifact filenames in download links and install snippets - ([54863e4](https://github.com/Hephaestus-Studio/aether-api/commit/54863e486fc305bc3579c9e1986578367e75fd2f))

### Documentation

- _(changelog)_ Update CHANGELOG.md for v0.2.0-beta [skip ci] - ([b858032](https://github.com/Hephaestus-Studio/aether-api/commit/b858032b6e0add21d1cc2c6b10f79c4af4cb3d10))

### Features

- _(website)_ Create landing page and GitHub Pages deployment workflow - ([453c1c4](https://github.com/Hephaestus-Studio/aether-api/commit/453c1c46a144c298b100b10c6e2f88af2f3cdb2e))
...
- _(ui)_ Use generic placeholder for workspace location inputs - ([bec4120](https://github.com/Hephaestus-Studio/aether-api/commit/bec4120b01efd4145c01f2cb0f8ef2785170111e))
...
- _(changelog)_ Update CHANGELOG.md for v0.2.0-beta [skip ci] - ([bb473b6](https://github.com/Hephaestus-Studio/aether-api/commit/bb473b62ae15cde184528e87a09eb7751f3af3b9))
